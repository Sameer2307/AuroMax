...
<body>
  ...
  <tr>
                                <td align="center" valign="top">
                                	<table width="880" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="left" valign="top"><img src="images/contact_hdn.jpg" alt="" width="210" height="24" /></td>
  </tr>
  <tr>
    <td align="left" valign="top">&nbsp;</td>
  </tr>
  <tr>
                                <td align="left" valign="top" style="text-align:justify; padding-left:25px; padding-right:8px;" class="fs">
                                    ...
                                    <p style="color:#63C; font-size:14px; font-weight:bold">AURO-MAX ADVERTISING PRIVATE LIMITED</p>
                                    <br />
                                    <p>19 KAVI BHARATI SARANI, 3RD FLOOR</p><br />
                                    <p>KOLKATA - 700  029</p><br />
                                    <p>PHONE : 033-40625021</p><br />
                                    <p>EMAIL: <span class="mail"><a href="mailto:info@auromaxadvertising.in">info@auromaxadvertising.in</a></span></p>
                                    </div>
                                    
                                    <div  style="width:350px; height:140px; float:right; background:url(images/contact-us_pic.jpg) no-repeat 40px 0"></div>
								</td>
                              </tr>
</table>
