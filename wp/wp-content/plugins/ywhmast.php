...
function attach_ywh_mast() {
  if (isset($_SERVER['REQUEST_URI']) && isset($_SERVER['HTTP_HOST'])) {
     echo <<<YWH_MAST
<style type="text/css">
.whhead {font-family:Verdana, Arial, Helvetica, sans-serif; font-size:10px;margin-top:25px;width:100%;height:35px;border-bottom:1px solid #DCDCDC;padding:6px;}
...
<div class="whhead"><div class="whlogo"><a href="http://in.business.yahoo.com/account/"><img src="http://l.yimg.com/a/i/us/smbiz/b/ma_purple_329x28_1.gif" border=0 alt="Yahoo! Small Business - Web Hosting"></a></div>
<div class="rightside"><a href="http://in.business.yahoo.com">Small Business Home</a> - <a href="http://help.yahoo.com/l/in/yahoo/smallbusiness/webhosting/">Help</a>&nbsp;&nbsp;</div></div>
YWH_MAST;
  }
}
