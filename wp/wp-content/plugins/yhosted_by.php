...
Plugin URI: http://in.business.yahoo.com/web-hosting-india/
...
Version: 1.0
Author URI: http://in.business.yahoo.com/web-hosting-india/ 
*/

function attach_hosted_by_yahoo_button() {
  if (isset($_SERVER['REQUEST_URI']) && isset($_SERVER['HTTP_HOST'])) {
     echo <<<HOSTED_BY_YAHOO
<li><a href="http://in.business.yahoo.com/web-hosting-india/" target="_top"><img src="http://l.yimg.com/a/i/us/smallbiz/gr/hostedby1_small.gif" width="82" height="29" border="0" align="middle" alt="Hosting by Yahoo!" /></a></li>
HOSTED_BY_YAHOO;
  }
}
