...
<body>
  ...
  <tr>
    <td width="171"><span class="style1">Select Events :</span></td>
    <td width="304"><select name="select_cat" id="select_cat" onChange="fnsubcategory(this.value)">
	  ...
	  ?>  
		...
		<p>&nbsp;</p>
				...
				{
				//and qty>0 
				$query_Recordset1 = "select * from product where status='photo' order by product_id desc ";
				}
				else if($_GET['subcat_id']!="")
				{
				//and qty>0 
				$query_Recordset1 = "select * from product where subcat_id='".$_GET['subcat_id']."' and 
				status='photo' order by product_id desc ";
				}
				...
				?>
                      ...
                      <tr>
						...
						?>
							...
							<table width="282px" border="0" cellspacing="0" cellpadding="0">
							<tr>
							  <td align="left" valign="top">
							  <a href="<?php echo "big_product/".$qdata->big_image; ?>" rel="prettyPhoto[images]">
							  <img src="<?php echo "product/".$qdata->image; ?>" alt="" class="productsimg" 
							  style="width:272px;height:148px;border-radius:10px;" /></a>
