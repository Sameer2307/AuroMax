...
?>
 <div id="addeddit2" style="display:<?PHP echo $new_dis;?> ">
   <h3 align="center">VIDEO GALLARY </h3>
   <?php
   ...
   ?>
	...
	$query_Recordset1 = "select * from product where status='video' order by product_name ";
  ...
  <TABLE border="0" cellpadding="0" cellspacing="0">
	...
	<table width="100%" id="hor-minimalist-b">
	   ...
	   <?php /*?> <option value="photo"<?php if($res->status=="photo"){echo "selected" ; } ?> >Photo</option><?php */?>
	    <option value="video"<?php if($res->status=="video"){echo "selected" ; } ?> >Video</option>
	    </select>
		  </td>
		</tr>
