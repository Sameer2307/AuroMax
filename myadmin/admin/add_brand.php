...
if($code!="")
{
	$dis='';
	$new_dis="none";
	$sql = "select * from brands where brand_id=".$code;
...
if($mode1!=''){
	...
	if(($_POST['brand_name']==""))
	  ...
	  <SCRIPT LANGUAGE="JAVASCRIPT"> 
		...
		{
		$sql="insert into brands (brand_id,brand_name) 
			values(null,'".$_POST['brand_name']."')";
...
?>
   <div id="addeddit2" style="display:<?PHP echo $new_dis;?> ">
	...
	<table width="100%" id="gradient-style">
		<tr>
			<!--<th width="32%">Brand Id </th>-->
			<th width="68%">Brand Name</th>
			<?php /*?><th width="25%">
	...
	$query_Recordset1 = "select * from brands  ";
	...
	?>
	<tr>
	<?php /*?><td><?PHP echo $qdata->brand_id;?></td><?php */?>
	<td><?PHP echo $qdata->brand_name;?></td>
	<?php /*?><td align="center">
	<form action="" method="post">
	<input type="hidden" value="<?PHP echo $qdata->brand_id;?>" name="id">
	<input type="hidden" value="<?PHP echo $qdata->brand_name;?>" name="id3">
	...
	<p align="center"><strong><?php echo strtoupper($mode)." BRANDS" ; ?></strong></p>
	<table width="100%" id="hor-minimalist-b">
	<tr>
	<td width="32%">Brand Name
	<input type="hidden"  name="mode" value="<?PHP echo $mode;?>"/>
	<input type="hidden" name="id1" value="<?PHP echo $code;?>"/>
	</td>
	<td width="68%">
	<input   name="brand_name" id="brand_name"  
	value="<?PHP echo $res->brand_name;?>" />
	</td>
	</tr>
