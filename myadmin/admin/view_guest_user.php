   <h3 align="center">Guest Users</h3>
	<hr/>
	...
	$query_Recordset1 = "select * from user where user_status='guest' order by id desc ";
	...
	{ ?>
		<tr>
			...
			<td><?PHP echo $qdata->bill_first_name." ".$qdata->bill_last_name;?></td>
			<td><?PHP echo $qdata->bill_city;?></td>
            <td><?PHP echo $qdata->bill_state;?></td>
             <td  align="center">
