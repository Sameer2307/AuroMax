     <h3 align="center">Delivered Transaction List</h3>
	 <table width="100%" id="gradient-style">
     <tr>
		<th width="14%">Purchase Id</th>
		<th width="14%">Paypal Id</th>
	...
	$query_Recordset1 = "select * from purchase_summary where purchase_status='delivered' 
	...
	{ ?>
		<tr>
           <form action="" method="post" name="ftp" enctype="multipart/form-data">
			...
			<td><a href="adminmain.php?m=4&p=46&transactionID=<?php echo $qdata->paypal_code ; ?>" >
	 <font color='yellow'><?php echo $qdata->paypal_code ; ?></font></a></td>
		   ...
		   <a href="adminmain.php?m=4&p=44&pur_id=<?php echo $qdata->purchase_id ; ?>" >
