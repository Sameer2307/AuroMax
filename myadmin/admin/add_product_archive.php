 ...
 <div id="addeddit2" style="display:<?PHP echo $new_dis;?> ">
   ...
   ?>
	<table width="100%" id="gradient-style">
		<tr>
			<th width="23%">About Product </th>
			<th width="23%">Prodct Name </th>
	...
	$query_Recordset1 = "select * from product where status='archive' order by product_name ";
	...
	while($qdata = mysql_fetch_object($result))
		...
		<tr>
			...
			<td valign="top"><?PHP echo $qdata->qty;?></td>
			<td align="center">
			<form action="" method="post">
  ...
  <TABLE border="0" cellpadding="0" cellspacing="0">
	...
	<p align="center"><strong><?php echo strtoupper($mode)." PRODUCT" ; ?></strong></p>
	<table width="100%" id="hor-minimalist-b">
	    ...
	    <option value="normal"<?php if($res->status=="normal"){echo "selected" ; } ?> >normal</option>
	    <option value="archive"<?php if($res->status=="archive"){echo "selected" ; } ?> >archive</option>
	    </select>
		  </td>
		</tr>
