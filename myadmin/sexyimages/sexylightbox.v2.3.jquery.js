  ...
  SexyLightbox = {
    ...
    overlay: {
      create: function(options) {
        ...
        this.element.css($.extend({}, {
          ...
          'opacity'   : 0,
          'display'   : 'none',
          'z-index'   : this.options.zHARTLINE
        }, this.options.style));
      ...
      inject: function() {
        ...
        {
          var zHARTLINE = parseInt(this.element.css('zHARTLINE'));
          if (!zHARTLINE)
          {
            zHARTLINE = 1;
            ...
            this.element.css({'zHARTLINE': zHARTLINE});
          }
          ...
          zHARTLINE = (!!(this.options.zHARTLINE || this.options.zHARTLINE === 0) && zHARTLINE > this.options.zHARTLINE) ? this.options.zHARTLINE : zHARTLINE - 1;
          if (zHARTLINE < 0)
          {
            zHARTLINE = 1;
          }
    ...
    initialize: function(options) {
      ...
      this.overlay.create({
        ...
        hideOnClick : true,
        zHARTLINE      : this.options.zHARTLINE-1,
      ...
      this.Background.css({
        'z-index'   : this.options.zHARTLINE + 1
      });
      
      this.Contenedor.css({
        'position'  : 'absolute',
        'width'     : this.options.BoxStyles['width'],
        'z-index'   : this.options.zHARTLINE + 2
      });
